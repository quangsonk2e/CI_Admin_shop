...
class Register extends CI_Controller {
 ...
 function validation()
 {
  ...
  $this->form_validation->set_rules('user_email', 'Email Address', 'required|trim|valid_email|is_unique[member.email]');
  ...
  if($this->form_validation->run())
  {
   ...
   if($id > 0)
   {
    ...
    $config = array(
     ...
     'smtp_port' => 587,
     'smtp_user'  => 'quangsonk2e@gmail.com', 
                  'smtp_pass'  => 'A12345678a@', 
     'mailtype'  => 'html',
     'charset'    => 'iso-8859-1',
                   'wordwrap'   => TRUE
    );
    ...
    $this->email->from('quangsonk2e@gmail.com');
